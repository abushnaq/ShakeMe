...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    res = sqlite3_exec(database, [@"INSERT INTO PHRASES VALUES(5, 'Some people have gotten angry and thrown their ipad when I told them their future, Are you an angry ipad thrower?')" UTF8String], NULL, NULL, NULL);
    ...
    res = sqlite3_exec(database, [@"INSERT INTO PHRASES VALUES(14, 'Who needs a magic 8-ball when you&amp;ve got smiley-iPad-guy?')" UTF8String], NULL, NULL, NULL);
   ...
   res = sqlite3_exec(database, [@"INSERT INTO PHRASES VALUES(23, 'Turn me five times then shake me again for the truth about your future.')" UTF8String], NULL, NULL, NULL);
    ...
    res = sqlite3_exec(database, [@"INSERT INTO PHRASES VALUES(34, 'I wonder if your future would look different if I was an iPhone app instead of iPad. Maybe it would look smaller?')" UTF8String], NULL, NULL, NULL);
